...
use App\Http\Controllers\Backend\Auth\Admin\SettingController;
...
Route::group([
    ...
    //cycle module
    Route::get('cycle', [SettingController::class, 'cycleIndex'])->name('cycle.index');
    Route::resource('setting', 'Admin\SettingController', ['except' => ['show']]);
    Route::resource('kpi/company', 'Admin\KpiController', ['except' => ['show']]);
    Route::resource('kpi/division', 'Admin\KpiController', ['except' => ['show']]);
    Route::get('manage/user', [SettingController::class, 'manageUser'])->name('manage.user');
    Route::get('manage/report', [SettingController::class, 'report'])->name('manage.report');
});
